...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_ColorTexture1->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(),"../Engine/data/dirt001.tga");
	if(!result)
	{
		return false;
	}
	...
	result = m_ColorTexture2->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/dirt004.tga");
	if(!result)
	{
		return false;
	}
	...
	result = m_ColorTexture3->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/dirt002.tga");
	if(!result)
	{
		return false;
	}
	...
	result = m_ColorTexture4->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/stone001.tga");
	if(!result)
	{
		return false;
	}
	...
	result = m_AlphaTexture1->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/alpha001.tga");
	if(!result)
	{
		return false;
	}
	...
	// Load the first alpha texture object.
	result = m_NormalTexture1->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/normal001.tga");
	if(!result)
	{
		return false;
	}
	...
	result = m_NormalTexture2->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/normal002.tga");
	if(!result)
	{
		return false;
	}
